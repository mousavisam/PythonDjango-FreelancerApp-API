...
from ...controller.registration.login_controller import GetUserController, LoginController
...
urlpatterns = [
    ...
    path('login/get_user', GetUserController.as_view({'get': 'get_user'}), name='get_user'),
