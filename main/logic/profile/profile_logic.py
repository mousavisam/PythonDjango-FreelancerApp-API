...
from main.logic.certificate.certificate_logic import CertificateLogic
...
class ProfileLogic:
    ...
    def prepare_user_profile(self, user: User) -> Tuple[Profile, Dict, QuerySet, QuerySet]:
        ...
        user_certificates = self.certificate_logic.get_certificate_by_user(user)
        return user_profile, avg_of_user_rate, user_skills, user_certificates
